        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu bg-primary text-white min-h-full w-80 p-4 space-y-1">
                    ...
                    <li>
                        <NavLink
                            to="/dashboard/moderator/manageScholarships"
                            className={({ isActive }) => isActive ? 'bg-green-600 text-white font-semibold' : ''}
                        >Manage Scholarships</NavLink>
                    </li>
                    <li>
                        <NavLink
                            to="/dashboard/moderator/allReviews"
                            className={({ isActive }) => isActive ? 'bg-green-600 text-white font-semibold' : ''}
                        >All Reviews</NavLink>
                    </li>
                    <li>
                        <NavLink
                            to="/dashboard/moderator/allAppliedScholarship"
                            className={({ isActive }) => isActive ? 'bg-green-600 text-white font-semibold' : ''}
                        >All applied Scholarship</NavLink>
                    </li>
                    <li>
                        <NavLink
                            to="/dashboard/moderator/addScholarship"
                            className={({ isActive }) => isActive ? 'bg-green-600 text-white font-semibold' : ''}
